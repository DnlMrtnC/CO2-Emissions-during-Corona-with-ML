...
def demo_driving():
    ...
    plt.figure()    
    ax1 = dfapple_d[countries_d].plot(kind='line', x_compat=True)
    plt.xticks(rotation=60)
    plt.title("Transportation Type: %s" % "Driving")
    plt.ylabel("Percentage from Baseline 2020-01-13")
    #----
    ...
    plt.figure()    
    ax2 = dfapple_d[countries_d].rolling(window=7).mean().plot(kind='line', x_compat=True)
    plt.xticks(rotation=60)
    plt.title("Transportation Type: %s" % "Driving")
    plt.ylabel("Percentage from Baseline 2020-01-13\nwith 7-day Moving Average Applied")
...
def demo_transit():
    ...
    plt.figure() 
    ax1 = dfapple_t[countries_t].plot(kind='line', x_compat=True)
    plt.xticks(rotation=60)
    plt.title("Transportation Type: %s" % "Transit")
    plt.ylabel("Percentage from baseline 2020-01-13")
    #----
    ...
    plt.figure()     
    ax2 = dfapple_t[countries_t].rolling(window=7).mean().plot(kind='line', x_compat=True)
    plt.xticks(rotation=60)
    plt.title("Transportation Type: %s" % "Transit")
    plt.ylabel("Percentage from Baseline 2020-01-13\nwith 7-day Moving Average Applied")
